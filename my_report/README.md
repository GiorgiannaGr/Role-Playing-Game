...
# 2nd Deliverable
Πρωτού ξεκινήσω να εκτελώ τα βήματα του δεύτερου παραδοτέου, προσπάθησα να διορθώσω τις αστοχίες που είχα στο πρώτο παραδοτέο.
Όσον αφορά τα επίπεδα, άλλαξα την τιμή στο Order in Layer προκειμένου ο παίκτης να βρίσκεται πάνω από τα επίπεδα Ground & Decoration. Με αυτό τον τρόπο κατάφερα ο παίκτης μου να μην εξαφανίζεται πια κατά τη διάρκεια που περιπλανάται στον 2Δ χώρο όπως γινόταν. Έπειτα, προσπάθησα να διορθώσω την κάμερα για να μην φαίνεται το μπλε περιθώριο γύρω από το παιχνίδι μου. Στη συνέχεια, άλλαξα λίγο την διακόσμηση στο παιχνίδι, για την ακρίβεια πρόσθεσα περισσότερα διακοσμητικά στοιχεία για να είναι πιο γεμάτο.Αφού έκανα όλα τα παραπάνω, προχώρησα στην εκτέλεση των βημάτων του 2ου παραδοτέου.
