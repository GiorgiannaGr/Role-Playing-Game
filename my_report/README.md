...
1ο Βήμα: World Interactions- Blocking Movement. Σε αυτό το βήμα, παρόλο που ακουλούθησα πιστά τις οδηγίες όσον αφορά το tilemap collider, ο παίκτης μου συνεχίζει να περνά μέσα από τα εμπόδια. Σε αυτό το σημείο, προσπαθώ να καταλάβω τι συμβαίνει και δεν λειτουργεί σωστά. 
